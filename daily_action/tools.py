...
def filter_recent_logs(logs, n=2):
    """Return the n most recent logs sorted by timestamp descending."""
...
def create_health_data_tools(user_id: str):
    ...
    def get_apple_health_data() -> str:
        ...
        data = filter_recent_logs(retrieve_health_data(user_id))
...
# • Last synced: {data.get('timestamp', 'N/A')}"""
    ...
    def get_water_logs() -> str:
        ...
        logs = filter_recent_logs(retrieve_water_logs(user_id))
    ...
    def get_weight_logs() -> str:
        ...
        logs = filter_recent_logs(retrieve_weight_logs(user_id))
    ...
    def get_mood_logs() -> str:
        ...
        logs = filter_recent_logs(retrieve_mood_logs(user_id))
    ...
    def get_meal_logs() -> str:
        ...
        logs = filter_recent_logs(retrieve_meal_logs(user_id))
    ...
    def get_sleep_logs() -> str:
        ...
        logs = filter_recent_logs(retrieve_sleep_logs(user_id))
    ...
    def get_pain_logs() -> str:
        ...
        logs = filter_recent_logs(retrieve_pain_logs(user_id))
    ...
    def get_medication_logs() -> str:
        ...
        logs = filter_recent_logs(retrieve_medication_logs(user_id))
